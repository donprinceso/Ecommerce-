...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > e.getListenerIndex(d)) {
                    ...
                    l.fn = d;
                    l.priority = g;
                    for (var t = e.length - 1; 0 <= t; t--) if (e[t].priority <= g) return e.splice(t + 1, 0, l), {removeListener: v};
                    e.unshift(l)
                }
            ...
            once: function () {
                ...
                return function (g, l, v) {
                    ...
                    if (e) {
                        var t = e.listeners;
                        if (t.length) for (var t = t.slice(0), z, G = 0; G < t.length; G++) {
                            if (e.errorProof) try {
                                z =
                                    t[G].call(this, v, l, b, k)
                            } catch (u) {
                            } else z = t[G].call(this, v, l, b, k);
    ...
    (function () {
        ...
        var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            f = /&/g, h = />/g, k = /</g, g = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            v = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, e = function (a, b) {
        ...
        CKEDITOR.tools = {
            ...
            extend: function (a) {
                ...
                for (var g = 1; g < b; g++) {
                    ...
                    CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(n), function (b) {
                        if (!0 === e || null == a[b]) if (!c || b in c) a[b] = n[b]
                    })
                }
                return a
            },
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var b, e = [], c = 0; c < a.length; c++) if (b = a[c]) /@import|[{}]/.test(b) ? e.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : e.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e');
                return e.join("")
            },
            ...
            transformPlainTextToHtml: function (a, b) {
                var e = b == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    c = c.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), g = b == CKEDITOR.ENTER_P ? "p" : "div";
                if (!e) {
                    var n = /\n{2}/g;
                    if (n.test(c)) var d = "\x3c" + g + "\x3e", l = "\x3c/" + g + "\x3e",
            ...
            indexOf: function (a, b) {
                if ("function" == typeof b) for (var e = 0, c = a.length; e < c; e++) {
                    if (b(a[e])) return e
                } else {
            ...
            normalizeCssText: function (a, b) {
                var e = [], c, g = CKEDITOR.tools.parseCssText(a, !0, b);
            ...
            checkIfAnyArrayItemMatches: function (a, b) {
                for (var e =
                    0, c = a.length; e < c; ++e) if (a[e].match(b)) return !0;
                return !1
            },
            ...
            keystrokeToArray: function (a, b) {
                var e = b & 16711680, c = b & 65535, g = CKEDITOR.env.mac, n = [], d = [];
                ...
                return {display: n, aria: d}
            },
            transparentImageData: "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), e, c, g = 0; g < b.length; g++) if (e = b[g].split("\x3d"), c = decodeURIComponent(CKEDITOR.tools.trim(e[0]).toLowerCase()), c === a) return decodeURIComponent(1 < e.length ? e[1] : "");
                return null
            },
            ...
            getCsrfToken: function () {
                ...
                if (!a || 40 != a.length) {
                    var a = [], b = "";
                    if (window.crypto && window.crypto.getRandomValues) a = new Uint8Array(40), window.crypto.getRandomValues(a); else for (var e = 0; 40 > e; e++) a.push(Math.floor(256 * Math.random()));
                    for (e = 0; e < a.length; e++) var c = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[e] % 36), b = b + (.5 < Math.random() ? c.toUpperCase() :
                        c);
                    a = b;
            ...
            normalizeMouseButton: function (a, b) {
                ...
                for (var e = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE,
                    4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], c = 0; c < e.length; c++) {
                    var g = e[c];
            ...
            convertBytesToBase64: function (a) {
                var b = "", e = a.length, c;
                for (c = 0; c < e; c += 3) {
                    var g = a.slice(c, c + 3), n = g.length, d = [], l;
                    if (3 > n) for (l = n; 3 > l; l++) g[l] = 0;
                    d[0] = (g[0] & 252) >> 2;
                    d[1] = (g[0] & 3) << 4 | g[1] >> 4;
            ...
            style: {
                parse: {
                    ...
                    _findColor: function (a) {
                        var b = [], e = CKEDITOR.tools.array, b = b.concat(a.match(this._rgbaRegExp) || []),
            ...
            array: {
                ...
                forEach: function (a, b, e) {
                    ...
                    for (var c = 0; c < a.length; c++) if (b.call(e, a[c], c, a)) return !0;
                    return !1
                }
            },
            object: {
                ...
                entries: function (a) {
                    ...
                    var b = Object.prototype.hasOwnProperty, e = [], c = CKEDITOR.tools.object.DONT_ENUMS;
                    if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (!a || "object" !== typeof a)) {
                        b = [];
                        if ("string" === typeof a) for (e = 0; e < a.length; e++) b.push(String(e));
                        return b
                    }
                    for (var g in a) e.push(g);
                    if (CKEDITOR.env.ie &&
                        9 > CKEDITOR.env.version) for (g = 0; g < c.length; g++) b.call(a, c[g]) && e.push(c[g]);
                    return e
                    ...
                    var e = CKEDITOR.tools, c = e.clone(a), g = e.clone(b);
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, h = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, g = {"#": 1},
        ...
        a(b, {
            ...
            video: 1,
            wbr: 1
        }, g, {acronym: 1, applet: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1});
        a(c, f, b, l);
        d = {
            a: d(b, {a: 1, button: 1}),
            abbr: b,
        ...
        a(d, {
            $block: a({audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1}, f, l),
            $blockLimit: {
                article: 1,
                aside: 1,
                audio: 1,
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        appendTo: function (a, d) {
            ...
            do if (!a || b.equals(this) || b.type != CKEDITOR.NODE_TEXT || !f && !b.isEmpty()) c++, f = b.type == CKEDITOR.NODE_TEXT; while (b = b.getPrevious());
            return c
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            type: CKEDITOR.NODE_ELEMENT, addClass: f ? function (a) {
            ...
            is: function () {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++) if (e) for (var t =
                        0; t < e.length; t++) b.push([a, c[d], e[t]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                var b = 0, c = 0, e = this.getDocument(), d = e.getBody(), t = "BackCompat" == e.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var f = this.$.getBoundingClientRect(), h = e.$.documentElement,
                        u = h.clientTop || d.$.clientTop || 0, n = h.clientLeft || d.$.clientLeft || 0, k = !0;
                ...
                } else for (u = this, n = null; u && "body" != u.getName() &&
                "html" != u.getName();) {
                ...
                t = a.getWindow();
                d = u(this, t);
                var y = u(a, t), H = this.$.offsetHeight;
                e = this.$.offsetWidth;
                var I = a.$.clientHeight, m = a.$.clientWidth;
            ...
            getFrameDocument: function () {
                ...
                for (var e = 0; e < c.length; e++) {
                    var d = c[e], t = d.nodeName.toLowerCase(), f;
                    if (!(t in b)) if ("checked" == t && (f = this.getAttribute(t))) a.setAttribute(t, f); else if (!CKEDITOR.env.ie || this.hasAttribute(t)) f = this.getAttribute(t), null === f && (f = d.nodeValue), a.setAttribute(t, f)
                }
                "" !== this.$.style.cssText &&
                ...
                if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) {
                    var d = e.ownerDocument.createEventObject(), f;
                    for (f in b) d[f] = b[f];
                    e.fireEvent(c,
                        d)
                } else e[e[a] ? a : c](b)
            }, isDetached: function () {
                var a = this.getDocument(), b = a.getDocumentElement();
    ...
    (function () {
        function a(a, b) {
            ...
            e = c.endContainer;
            var f = c.startOffset, x = c.endOffset, h, g = this.guard, m = this.type,
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), g = CKEDITOR.dom.walker.temp(), l = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, e = b.getChildCount(); c < e; ++c) if (!v(b.getChild(c))) return !!a;
                return !a
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, f) {
            ...
            function n() {
                ...
                for (a = 0; a < e; a++) if (b = S[a], c = p[a], !b.equals(c)) return a;
                return a - 1
            }

            function g() {
                var b = N - 1, c = C && F && !m.equals(B);
            ...
            a.optimizeBookmark();
            var k = 0 === b, v = 1 == b, l = 2 == b;
            b = l || v;
            var m = a.startContainer, B = a.endContainer,
                K = a.startOffset, A = a.endOffset, M, r, C, F, w, T;
            if (l && B.type == CKEDITOR.NODE_TEXT && (m.equals(B) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(B))) c.append(a.document.createText(B.substring(K, A))); else {
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var c = this.startContainer, d = this.endContainer, f = this.collapsed, h, n, g, k;
                ...
                return {startNode: a ? g + (f ? "C" : "S") : h, endNode: a ? g + "E" : n, serializable: a, collapsed: f}
            }, createBookmark2: function () {
                function a(b) {
                    var e = b.container, d = b.offset, n;
                    n = e;
                    var f = d;
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
                        a:{
                            for (n = e; d--;) if (f = n.getChild(d).getIndex(!0), 0 <= f) {
                                d = f;
                                break a
                            }
                            d = -1
                    ...
                    if (e.type == CKEDITOR.NODE_TEXT) {
                        n = e;
                        for (f = 0; (n = n.getPrevious()) && n.type == CKEDITOR.NODE_TEXT;) f += n.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
                        n = f;
                ...
                return function (c) {
                    var d = this.collapsed, f = {container: this.startContainer, offset: this.startOffset},
                        n = {container: this.endContainer, offset: this.endOffset};
                    c && (a(f), b(f, this.root),
                    d || (a(n), b(n, this.root)));
                    return {
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) if (f = b.getChildCount(), f > d) b = b.getChild(d).getPreviousSourceNode(!0);
                else if (1 > f) b = b.getPreviousSourceNode(); else {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var n = this.getCommonAncestor(), g = this.root, k, v, l, m, B, K = !1, A, M;
                        ...
                        for (l = c(l); l || m;) {
                            ...
                            for (; m;) if (A = !1, m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious(); else {
                                if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), d.test(M) && (m = null), A = /[\s\ufeff]$/.test(M); else if ((m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                    M = m.getText();
                                    if (d.test(M)) m = null; else for (var r = m.$.getElementsByTagName("*"), C = 0, F; F = r[C++];) if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
                                        m = null;
                                        break
                                    }
                                    m && (A = !!M.length)
                        ...
                        for (; l || m;) {
                            ...
                            for (; m;) {
                                A = !1;
                                if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), h(m, 0) || (m = null), A = /^[\s\ufeff]/.test(M); else if (m.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                        M = m.getText();
                                        if (d.test(M)) m =
                                            null; else for (r = m.$.getElementsByTagName("*"), C = 0; F = r[C++];) if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) {
                                            m = null;
                                            break
                                        }
                                        m && (A = !!M.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var O = CKEDITOR.dom.walker.whitespaces(), q = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var h = this.clone(), n = this.startContainer, g = this.endContainer, k = this.startOffset,
                        l = this.endOffset,
                        v = c = 1;
                    ...
                    var h = new CKEDITOR.dom.walker(h), m = CKEDITOR.dom.walker.bookmark(),
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, h = d.block, n = null;
                ...
                return {previousBlock: f, nextBlock: h, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: n}
                ...
                var c, d = 0, f, h, n = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
            ...
            moveToElementEditEnd: function (a) {
                ...
                var b = this.getTouchedStartNode(), c = this.getTouchedEndNode(), d = b.getAscendant("table", !0),
                ...
                function a(b, c) {
                    var d = CKEDITOR.tools.array.map(b, function (a) {
                        return a
                    }), e = new CKEDITOR.dom.range(c.root), f, h, g;
                ...
                return void 0 !== this.document.getSelection ? function (d) {
                    var f = this.root.getDocument().$.createRange(), n;
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [], h, n, g, k;
                if (c && c.find) for (n = c.find(a), h = 0; h < n.count(); h++) if (c = n.getItem(h), b || !c.isReadOnly()) g = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
    ...
    (function () {
        ...
        function b(a, c, f, h) {
            ...
            a._.nestedEditable = {element: h.element, container: f, remaining: h.remaining, iterator: c};
            return 1
        }
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = u.startPath();
                    var n = u.endPath(), L = !u.collapsed && c(u, k.block), y = !u.collapsed && c(u, n.block, 1);
                ...
                for (this._.nextNode = null; n;) {
                    var L = 0, y = n.hasAscendant("pre"), H = n.type != CKEDITOR.NODE_ELEMENT, I = 0;
                    if (H) n.type == CKEDITOR.NODE_TEXT && f.test(n.getText()) && (H = 0); else {
                        var m = n.getName();
                        if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) {
                            d = n;
                            b(this, a, d);
                            break
                        } else if (n.isBlockBoundary(this.forceBrBreak && !y && {br: 1})) {
                            if ("br" == m) H = 1; else if (!k && !n.getChildCount() && "hr" != m) {
                                d = n;
                                t = n.equals(u);
                                break
                            }
                    ...
                    t = (!L || H) && n.equals(u);
                    if (k && !L) for (; !n.getNext(g) && !t;) {
                        m = n.getParent();
                        if (m.isBlockBoundary(this.forceBrBreak && !y && {br: 1})) {
                            L = 1;
                            H = 0;
                            t || m.equals(u);
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                m = b[f];
                m = "boolean" == typeof m ? {} : "function" == typeof m ? {match: m} : C(m);
                ...
                for (r in T) {
                    q[r] = k(q[r], F) || null;
                    var h = q, p = S[r], n = k(q[S[r]], F), g = q[r], w = [], E = !0, N = void 0;
                    n ? E = !1 : n = {};
            ...
            for (d = a.length; c < d; ++c) {
                ...
                if (!0 === f.elements ||
                    null === f.elements) e[m ? "unshift" : "push"](f); else for (B in q = f.elements, delete f.elements, q) if (b[B]) b[B][m ? "unshift" : "push"](f); else b[B] = [f]
            }
        }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, e = !0 === a, m = b.length; m--;) if (e || a(b[m])) b.splice(m, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function g(a, b) {
            ...
            var c, d, e, f;
            if (e = a.requiredClasses) for (f = b.classes, c = 0; c < e.length; ++c) if (d = e[c], "string" == typeof d) {
        ...
        function z(a, b, e, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var p = 0, h = r.length, g; p < h; ++p) if (g = r[p](b)) {
                        r = g;
                        break a
                    }
                    r = void 0
            ...
            if (f.doFilter) {
                a:{
                    p = b.name;
                    h = a._;
                    a = h.allowedRules.elements[p];
                    r = h.allowedRules.generic;
                    p = h.disallowedRules.elements[p];
                    ...
                    if (a || r) {
                        t(b);
                        if (p) for (w = 0, C = p.length; w < C; ++w) if (!1 === c(p[w], b, k)) {
                            a = null;
                            break a
                        }
                        if (h) for (w = 0, C = h.length; w < C; ++w) c(h[w], b, k);
                        if (a) for (w = 0, C = a.length; w < C; ++w) d(a[w], b, k, g);
                        if (r) for (w = 0, C = r.length; w < C; ++w) d(r[w], b, k, g);
                        a = k
                    } else a = null
                }
                ...
                var N = a.validStyles;
                r = a.validClasses;
                var p = b.attributes, E = b.styles, h = b.classes;
                g = b.classBackup;
                var B = b.styleBackup, A, K, l = [], k = [], M = /^data-cke-/;
                w = !1;
                delete p.style;
                delete p["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (A in p) C[A] || (M.test(A) ? A == (K = A.replace(/^data-cke-saved-/, "")) || C[K] || (delete p[A], w = !0) : (delete p[A], w = !0));
                ...
                w && (F = 1);
                if (!f.skipFinalValidation && !n(b)) return e.push(b), 1
            }
        ...
        function I(a, b, c) {
            ...
            if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (r.$block[d] || "tr" == d) if ("br" == b) a.previous && !H(a.previous) && (b = y(), b.insertBefore(a)), a.next && !H(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = r[b];
                    for (var f = 0, m = d.length, q; f < m; ++f) if (q = d[f], q.type == CKEDITOR.NODE_ELEMENT && !e[q.name]) {
                        e = !1;
                        break b
                    }
                    e = !0
        ...
        function B(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, f, m, q, p;
            if (a.name != c.element) return !1;
            for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), q = a.classes.join("|"); p = c.pop();) {
                if (-1 == q.indexOf(p)) return !1
            } else if (a.attributes[f] != d[f]) return !1;
            for (m in e) if (a.styles[m] !=
                e[m]) return !1;
            return !0
        }
        ...
        var r = CKEDITOR.dtd, C = CKEDITOR.tools.copy, F = CKEDITOR.tools.trim, w = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, f = [], m = this.editor && this.editor.config.protectedSource, q, p = !1,
                    h = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (q = z(e, a, f, h), q & 1) p = !0; else if (q & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var r, F, n;
                            if (m) for (F = 0; F < m.length; ++F) if ((n = d.match(m[F])) && n[0].length == d.length) {
                                c =
                                    !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (r = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, r, c, h);
                            c = !c.length
                        }
                        c || f.push(a)
                    }
                ...
                for (; F = a.pop();) if (c = F.el, c.parent) switch (g = r[c.parent.name] || r.span, F.check) {
                    case "it":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var f = void 0, m = void 0, q = void 0, p = void 0, r = void 0, h = void 0;
                        c = [];
                ...
                var p = CKEDITOR.tools.clone(f), r = [], h;
                if (!1 !== b && (h = this._.transformations[f.name])) {
                    for (d =
                             0; d < h.length; ++d) m(this, f, h[d]);
                    u(f)
                }
                z(this, p, r, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var T = {styles: 1, attributes: 1, classes: 1},
            ...
            N = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, O = /^cke:(object|embed|param)$/,
            q = /^(object|embed|param)$/, E;
        E = CKEDITOR.filter.transformationsTools = {
            ...
            }, matchesStyle: B, transform: function (a, b) {
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, f = c.attributes, e, m, q, p;
                    a.name = c.element;
                    for (e in f) if ("class" == e) for (c =
                                                            a.classes.join("|"), q = f[e].split(/\s+/); p = q.pop();) -1 == c.indexOf(p) && a.classes.push(p); else a.attributes[e] = f[e];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, f, h) {
                ...
                k && (b = [b]);
                f || (f = CKEDITOR);
                var g = b.length, l = [], v = [], e = function (a) {
        ...
        add: function (a, d) {
            ...
            CKEDITOR.scriptLoader.load(h,
                function (a, e) {
                    ...
                    for (var f = 0; f < a.length; f++) for (var h = k[a[f]], l = 0; l < h.length; l++) {
                        var n = h[l];
                        g[n] = this.get(n);
                        c[n] = 1
                    }
        ...
        return function (b, c, f) {
            var h = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], e;
                    for (e in a) {
                        var g = a[e], t = g && g.requires;
                        if (!d[e]) {
                            if (g.icons) for (var z = g.icons.split(","), G = z.length; G--;) CKEDITOR.skin.addIcon(z[G], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + z[G] + ".png");
    ...
    (function () {
        ...
        function x(a) {
            ...
            var c = a.config, d = b(c.plugins), e = b(c.extraPlugins), f = b(c.removePlugins);
            if (e) var h = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(h, ""),
                d = d + ("," + e);
            if (f) var g = new RegExp("(?:^|,)(?:" + f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g,
                "");
            ...
            CKEDITOR.plugins.load(d.split(","), function (b) {
                ...
                for (var m in b) {
                    var h = b[m], k = h.lang, B = null, p = h.requires, N;
                    CKEDITOR.tools.isArray(p) && (p = p.join(","));
                    if (p && (N = p.match(g))) for (; p = N.pop();) CKEDITOR.error("editor-plugin-required", {
                        plugin: p.replace(",", ""),
                        requiredBy: m
                    });
                ...
                CKEDITOR.scriptLoader.load(f, function () {
                    if (!a.isDestroyed() && !a.isDetached()) {
                        for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++) for (var m = 0; m < d.length; m++) {
                            var p = d[m];
        ...
        function z(a, b) {
            function c(a) {
                var b =
                    a.startContainer, d = a.endContainer;
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, h, g, k = 0; k < a.length; k++) {
                var l = a[k], r = l.startContainer.getAscendant("tr", !0);
            ...
            plugins: {
                detectConflict: function (a, b) {
                    for (var c = 0; c < b.length; c++) {
                        var d = b[c];
                        if (this[d]) return CKEDITOR.warn("editor-plugin-conflict", {plugin: a, replacedWith: d}), !0
                    }
                    return !1
                }
                ...
                var b = CKEDITOR.filter.instances, c = this;
                ...
                var c = this.editable(), d = this.getSelection().getRanges(), e = new CKEDITOR.dom.documentFragment, f;
                ...
                var c = "string" === typeof a ? this.getCommand(a) : a, d = [];
                if (c) {
                    var e = CKEDITOR.tools.object.findKey(this.commands, c), f = this.keystrokeHandler.keystrokes;
                    if (c.fakeKeystroke) d.push(c.fakeKeystroke); else for (var h in f) f[h] === e && d.push(h)
                }
                return b ? d : d[0] || null
            }, addFeature: function (a) {
        ...
        CKEDITOR.editor._getEditorElement = function (a) {
            ...
            return b ? b.getEditor() ? (CKEDITOR.error("editor-element-conflict", {editorName: b.getEditor().name}), null) : b : (CKEDITOR.error("editor-incorrect-element", {element: a}), null)
        }
    })();
    ...
    (function () {
        ...
        var d = CKEDITOR.tools.extend({
            ...
            c = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {
                style: 1,
                script: 1
            }), f = {ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td"};
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (h, k, g) {
                function l(a) {
                    var b;
                    if (0 < n.length) for (var c = 0; c < n.length; c++) {
                        var d = n[c], e = d.name, f = CKEDITOR.dtd[e], h = y.name && CKEDITOR.dtd[y.name];
                ...
                var G = new CKEDITOR.htmlParser,
                    ...
                    n = [], L = [], y = u, H = "textarea" == u.name, I = "pre" == u.name;
                    ...
                    if (a(f)) n.push(f); else {
                        ...
                        if ("br" == e) L.push(f); else {
                            for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || y.isUnknown || g[e]);) if (y.isOptionalClose) G.onTagClose(h); else if (e in b && h in b) h = y.children, (h = h[h.length - 1]) && "li" == h.name || x(h = new CKEDITOR.htmlParser.element("li"), y), !f.returnPoint && (f.returnPoint = y), y = h; else if (e in CKEDITOR.dtd.$listItem &&
                                !z(e, h)) G.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (h in d && !z(e, h)) !f.returnPoint && (f.returnPoint = y), y = y.parent; else if (h in CKEDITOR.dtd.$inline && n.unshift(y), y.parent) x(y, y.parent, 1); else {
                                f.isOrphan = 1;
                                break
                            }
                            l(e);
                ...
                G.onTagClose = function (a) {
                    for (var b = n.length - 1; 0 <= b; b--) if (a == n[b].name) {
                        n.splice(b, 1);
                        return
                    }
                ...
                G.onText = function (a) {
                    ...
                    if (!H && !e["#"] && b in d) G.onTagOpen(f[b] || ""), G.onText(a); else {
                        v();
                        l();
                        I || H || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    h = Array.prototype.slice.call(arguments, 1), k = this.rules, g = k.length, l, v, e, x;
                for (x = 0; x < g; x++) if (d && (l = c.type, v = c.name), e = k[x], !(a.nonEditable && !e.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            function p(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var q = [], p = b(f), m, F;
                        if (p) for (r(p, 1) && q.push(p); p;) h(p) && (m = c(p)) && r(m) && ((F = c(m)) && !h(F) ? q.push(m) : (e(g).insertAfter(m), m.remove())), p = p.previous;
            ...
            var F = {elements: {}}, g = "html" == d, w = CKEDITOR.tools.extend({}, m), C;
        ...
        function u(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
                    {id: 1}), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g,
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            f.addRules(A);
            f.addRules(M, {applyToAll: !0});
            f.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, f, c = n(c), c = u(c, b), c = e(c, T), c = v(c), c = e(c, w),
                    c = c.replace(p, "$1cke:$2"), c = c.replace(O, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
            ...
            b.on("toDataFormat", function (a) {
                var c = a.data.dataValue, d = m.writer;
                d.reset();
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                return e.fire("toHtml", {
                    ...
                    filter: p || e.filter, enterMode: m || e.enterMode, protectedWhitespaces: h
                }).dataValue
        ...
        var L = /(?:&nbsp;|\xa0)$/, y = "{cke_protected}", H = CKEDITOR.dtd,
            I = "caption colgroup col thead tfoot tbody".split(" "), m = CKEDITOR.tools.extend({}, H.$blockLimit,
            H.$block), B = {elements: {input: g, textarea: g}}, K = {
                ...
                elements: {
                    ...
                    table: function (a) {
                        a.children.slice(0).sort(function (a, b) {
                            var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(I, a.name), d = CKEDITOR.tools.indexOf(I, b.name));
        ...
        var r = /<(a|area|img|input|source)\b([^>]*)>/gi,
            C = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, F = /^(href|src|name)$/i,
            w = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, S = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            p = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi,
            N = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, O = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        n = function () {
            function a(c) {
                return CKEDITOR.tools.array.reduce(c.split(""), function (a, c) {
                    var d = c.toLowerCase(), e = c.toUpperCase(), f = b(d);
                    d !== e && (f += "|" + b(e));
                    return a + ("(" + f + ")")
                }, "")
            }
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var l, v;
                for (l in k) {
                    for (g = k[l]; ;) if (v = a.onAttributeName(b, l)) if (v != l) delete k[l], l = v; else break; else {
                        delete k[l];
                        break
                    }
                ...
                b && this.filter(b);
                var h = this.name, k = [], g = this.attributes, l, v;
                a.openTag(h, g);
                ...
                var d = null, k = CKEDITOR.tools.array.find(this.children, function (g) {
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, d, b;
            for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b),
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, k = a.elementMode, g = a.fire("uiSpace", {space: "top", html: ""}).html,
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    var g = d.checkDirty(), k = d._.previousModeData, l, v = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = l = d.getData(1);
                    "source" == d.mode && k == l && (d.fire("lockSnapshot", {forceUpdate: !0}), v = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var g = this.container, l = this.ui.space("contents"),
            ...
            k.setSize("width", a, !0);
            v && (v.style.width = "1%");
            var e = (k.$.offsetHeight || 0) - (l.$.clientHeight || 0), g = Math.max(b - (d ? 0 : e), 0);
            b = d ? b + e : b;
            l.setStyle("height", g + "px");
            v && (v.style.width = "100%");
            this.fire("resize", {outerHeight: b, contentsHeight: g, outerWidth: a || k.getSize("width")})
        };
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection, r = g.getRanges()[0], h;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (g = d(g, e)) g.appendBogus(), h = CKEDITOR.env.ie && !CKEDITOR.env.edge || CKEDITOR.env.edge && b._.previousActive;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var g, F;
                    if (f) for (; (g = b.getCommonAncestor(0, 1)) && (F = CKEDITOR.dtd[g.getName()]) && (!F || !F[e]);) if (g.getName() in
                        CKEDITOR.dtd.span) {
                        var f = b.splitElement(g), h = b.createBookmark();
                        l(g);
                        l(f);
                        b.moveToBookmark(h)
                ...
                fixInitialSelection: function () {
                    ...
                    var c = I, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var g = f.getHead(), r = g.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in C) {
                                    var e, f = b.getRanges()[0], r = f.startPath(), g, q, k, c = 8 == c;
                                    CKEDITOR.env.ie &&
                            ...
                            if (c in C && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                if (d.collapsed) a:{
                                    ...
                                    if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                        ...
                                        d = d.startPath().block;
                                        if (!d || d && d.contains(f)) b = void 0; else {
                                            a.fire("saveSnapshot");
                                            var r;
                ...
                cleanCustomData: function () {
                    ...
                    if (!this.is("textarea")) {
                        var a = this.getDocument(), b = a.getHead();
        ...
        n = function () {
            ...
            function b(c, d) {
                var e, f, r, g, h = [], k = d.range.startContainer;
                e = d.range.startPath();
                ...
                l; ++C) e = w.getItem(C), a(e) ? (r = e.getName(), T && r in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (g = !!k[r], "br" != r || !e.data("cke-eol") || C && C != l - 1 || (v = (f = C ? h[C - 1].node : w.getItem(C + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && F.$block[f.getName()]), -1 != n || g || (n = C), g || (A = C), h.push({
                    ...
                    name: r,
                    allowed: g
                }), f = v = 0)) : h.push({isElement: 0, node: e, allowed: 1});
                -1 < n && (h[n].firstNotAllowed = 1);
                -1 < A && (h[A].lastNotAllowed = 1);
                return h
            }

            function d(b, c) {
                var e = [],
                    f = b.getChildren(), r = f.count(), g, h = 0, k = F[c], C = !b.is(F.$inline) || b.is("br");
            ...
            var F = CKEDITOR.dtd, w = {
                p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1,
                h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, v = CKEDITOR.tools.extend({}, F.$inline);
            delete v.br;
            return function (p, w, O, q) {
                ...
                if (!q.checkReadOnly()) {
                    ...
                    var D = w.range, t = w.mergeCandidates, J = "html" === w.type, x, u, z, y, G, V;
                    "text" == w.type &&
                    ...
                    for (; (G = e(D)) && a(G) && G.isBlockBoundary() && z.contains(G);) D.moveToPosition(G,
                    ...
                    for (x = u.startNode; (x = x.getParent()) && f(x);) t.push(x);
                    D.moveToBookmark(u);
                    ...
                    if (p = O) {
                        ...
                        if ((H = p.startPath().block) && (1 != H.getChildCount() || !H.getBogus())) a:{
                            ...
                            if (1 == q.getChildCount() && a(P = q.getFirst()) && P.is(n) && !P.hasAttribute("contenteditable")) {
                                ...
                                p = 0;
                                for (V = H.count(); p < V; p++) if (E = H.getItem(p), !E.is(v)) break a;
                        ...
                        for (h(E, P); V < E.length; V++) {
                            ...
                            if (J) O = 0 < V; else {
                                ...
                                if (u && D.isElement) {
                                    ...
                                    if (J) x && (L = P.splitElement(x), w.zombies.push(L), w.zombies.push(x)); else {
                                        x = q.getName();
                                        Z = !V;
                                        J = V == E.length - 1;
                                        x = d(D.node, x);
                    ...
                    if (L) for (; Q = L.pop();) CKEDITOR.env.needsBrFiller ? Q.appendBogus() : Q.append(R.document.createText(" "));
                    for (; Q = w.mergeCandidates.pop();) Q.mergeSiblings();
                    R.moveToBookmark(Z);
                    if (!w.dontMoveCaret) {
                        for (Q = e(R); Q && a(Q) && !Q.is(F.$empty);) {
                            if (Q.isBlockBoundary()) R.moveToPosition(Q, CKEDITOR.POSITION_BEFORE_END); else {
        ...
        H = {
            eol: {
                detect: function (a, b) {
                    var c = a.range, d = c.clone(), e = c.clone(),
                ...
                list: {
                    ...
                    detectMerge: function (a, b) {
                        ...
                        if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                            var d =
                                    a.mergeBlockBookmark.startNode, e = a.mergeBlockBookmark.endNode,
                                f = new CKEDITOR.dom.elementPath(d, c), g = new CKEDITOR.dom.elementPath(e, c),
                                f = f.block, g = g.block;
                    ...
                    function a(c) {
                        var e = [], f, g = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d),
                            p = c.endPath().contains(d), k = {};
                        g.guard = function (a, g) {
                            ...
                            if (g &&
                                h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && p && a.equals(p)) f = c.clone(), f.setStartAt(p, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
                                if (l = !g) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!p || b(a, p));
                                if (!l && (l = g)) if (a.is(d)) var l = h && h.getAscendant("table", !0),
                                    n = p && p.getAscendant("table", !0), m = a.getAscendant("table", !0),
                                    l = l && l.contains(m) || n && n.contains(m); else l = void 0;
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var g = c(f, e.bookmark), h = g.clone(), k, p, l = g.getCommonAncestor();
    ...
    (function () {
            ...
            if (b) {
                ...
                if (!(e = !c) && (e = !c.isHidden())) {
                    ...
                    if (a(e.getSelectedElement())) e = !1; else {
                        var q = 1 === f.length && f[0].collapsed, g = d(f, !!CKEDITOR.env.webkit) &&
                            d(g);
        ...
        function v(a) {
            ...
            var c = a.startContainer, d = a.getPreviousNode(l,
                null, c), e = a.getNextNode(l, null, c);
        ...
        var n = "function" != typeof window.getSelection, L = 1, y = CKEDITOR.tools.repeat("​", 7),
            H = new RegExp(y + "( )?", "g"), I, m, B, K = CKEDITOR.dom.walker.invisible(1), A = function () {
                function a(b) {
                    return function (a) {
                        var c =
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var f = c.document, g = CKEDITOR.document, q = c.editable(), r = f.getBody(),
                    l = f.getDocumentElement(), C = q.isInline(),
                    m, v;
            ...
            getNative: function () {
                ...
                var a = n ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, r = -1, n, m; k <= l;) if (r = Math.floor((k + l) / 2), f = e[r], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n) l = r - 1; else if (0 > n) k = r + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        ...
                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!h) return {container: d, offset: a(f) + (0 < n ? 0 : 1)};
                        for (; 0 < h;) try {
                        ...
                        return {container: m, offset: 0 < n ? -h : m.nodeValue.length + h}
                    };
                    return function () {
                ...
                if (this.isLocked) {
                    if (a) var b =
                        this.getSelectedElement(), c = this.getRanges(), e = this.isFake;
                    this.isLocked = 0;
                    this.reset();
                ...
                this.reset();
                if (c) for (var c = this.root, g, h = 0; h < a.length; ++h) g = a[h], g.endContainer.equals(c) && (g.endOffset = Math.min(g.endOffset,
                    c.getChildCount()));
                if (a.length) if (this.isLocked) {
                    ...
                    a:{
                        var l, m;
                        if (1 == a.length && !(m = a[0]).collapsed && (p = m.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (m = m.clone(), m.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = m.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (p = l), "false" == p.getAttribute("contenteditable"))) break a;
                        p = void 0
                    }
                    if (p) this.fake(p); else if (b && b.plugins.tableselection &&
                        b.plugins.tableselection.isSupportedEnvironment() && d(a) && !I && !a[0]._getTableElement({table: 1}).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
                        if (n) {
                            l = CKEDITOR.dom.walker.whitespaces(!0);
                            p = /\ufeff|\u00a0/;
                            m = {table: 1, tbody: 1, tr: 1};
                            ...
                            for (D = 0; D < a.length; D++) {
                                ...
                                try {
                                    ...
                                    if (0 <= u.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), E.setEnd(b.endContainer.$, b.endOffset); else throw u;
                                }
                                k.addRange(E)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            var e = c.document;
            if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var v = c.createBookmark(), r = v.startNode, x = v.endNode, t = r, u;
                if (!l) {
                    var w = c.getCommonAncestor(), l = a(r, w), w = a(x, w);
                    l && (t = l.getNextSourceNode(!0));
                    w && (x = w)
                }
                for (t.getPosition(x) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                    l = !1;
                    if (t.equals(x)) t = null, l = !0; else {
                        ...
                        if (w && m && CKEDITOR.dtd.$block[z]) for (var A = t, B = f(A), C = void 0, H = B.length, I = 0, A = H && new CKEDITOR.dom.range(A.getDocument()); I < H; ++I) {
                            var C = B[I], K = CKEDITOR.filter.instances[C.data("cke-filter")];
                            if (K ? K.check(this) : 1) A.selectNodeContents(C), b.call(this, A)
                        }
                        B = z ? !n[z] || y ? 0 : w && !m ? 0 : d(t, x, h, T) : 1;
                        if (B) if (C = t.getParent(), B = h, H = g, I = k, !C || !(C.getDtd() || CKEDITOR.dtd.span)[H] && !I || B.parentRule &&
                        !B.parentRule(C)) l = !0; else {
                            if (u || z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(x) | T) != T || (u = c.clone(), u.setStartBefore(t)), z = t.type, z == CKEDITOR.NODE_TEXT || w || z == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) {
                                for (var z = t, M; (l = !z.getNext(F)) && (M = z.getParent(), n[M.getName()]) && d(M, r, h, S);) z = M;
                                u.setEndAfter(z)
                            }
                        } else l = !0;
        ...
        function c(a) {
            ...
            a.enlarge(CKEDITOR.ENLARGE_INLINE,
                1);
            var c = a.createBookmark(), d = c.startNode, e = this._.definition.alwaysRemoveElement;
            if (a.collapsed) {
        ...
        function z(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = I(this)[a.getName()],
                f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g;
            for (g in d) if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == m(g, d[g])) b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g), a.removeAttribute(g));
        ...
        function G(a) {
            ...
            for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || u(d, b[f])
        }
        ...
        function n(a, b) {
            if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) {
                var c = a.getPrevious(w), d = a.getNext(w);
        ...
        var A = {
            ...
            audio: 1,
            video: 1
        }, r = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0,
            1), w = CKEDITOR.dom.walker.whitespaces(1);
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c) if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? B(c[h], d) : c[h] == d) {
                            if (!b) return !0
                        } else if (b) return !1;
                        if (b) return !0
                    } else return !0
    ...
    (function () {
        ...
        CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
            var b = this.getRanges()[0], f = this.root.editor, h;
            if (this.root.editor._.shiftPressed || this.isFake || b.isCollapsed || b.startContainer.equals(b.endContainer)) h = !1; else if (0 === b.endOffset) h = !0; else {
            ...
            createIterator: function () {
                ...
                return {
                    getNextRange: function (k) {
                        ...
                        var g = a[h];
                        if (g && 1 < a.length) {
                            if (!h) for (var l = a.length - 1; 0 <= l; l--) d.unshift(a[l].createBookmark(!0));
                            if (k) for (var v = 0; a[h + v + 1];) {
                                var e = g.document;
                                k = 0;
                                ...
                                for (e = e.getById(d[v + 1].startNode); ;) {
                                    ...
                                    if (e.equals(l)) k = 1; else if (c(l) || l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) continue;
                                    break
                                }
                                if (!k) break;
                                v++
    ...
    (function () {
        ...
        var k = "cke_ui_color", g = [], l = /\$color/g;
...
*/
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "span", null, null, function () {
                            var c = CKEDITOR.tools.extend({}, a, {id: a.id ? a.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, !0),
                                e = [], d = CKEDITOR.tools.getNextId() + "_label",
                            ...
                            b, a, d, function () {
                                for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", k = 0; k < a.items.length; k++) {
                                    var l = a.items[k], h = void 0 !== l[2] ? l[2] : l[0],
                                        ...
                                        h = CKEDITOR.tools.extend({}, p, {title: h}, !0), r = {
                                            type: "radio",
    ...
    (function () {
        ...
        function Y(a) {
            var b = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", Z).output({
                ...
                })), c = b.getChild([0, 0, 0, 0, 0]), e = c.getChild(0),
                d = c.getChild(1);
        ...
        function ba(a) {
            function b(b) {
                var c = a.getSize(), k = a.parts.dialog.getParent().getClientSize(), q = b.data.$.screenX,
                    l = b.data.$.screenY, r = q - e.x, n = l - e.y;
                e = {x: q, y: l};
                d.x += r;
                d.y += n;
                q =
            ...
            var e = null, d = null, f = a.getParentEditor(),
                g = f.config.dialog_magnetDistance, h = CKEDITOR.skin.margins || [0, 0, 0, 0];
        ...
        function ca(a) {
            function b(b) {
                var c = "rtl" == f.lang.dir, q = k.width, l = k.height,
                    w = q + (b.data.$.screenX - m.x) * (c ? -1 : 1) * (a._.moved ? 1 : 2),
                    C = l + (b.data.$.screenY - m.y) * (a._.moved ? 1 : 2), E = a._.element.getFirst(),
                    E = c && parseInt(E.getComputedStyle("right"), 10), v = a.getPosition();
                v.x = v.x || 0;
                v.y = v.y || 0;
            ...
            if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f =
                    a.getParentEditor(), g, h, p, m, k, q, l = CKEDITOR.tools.addFunction(function (d) {
                    function e(a) {
                        return a.isVisible()
                    }

                    k = a.getSize();
                    var f = a.parts.contents, l = f.$.getElementsByTagName("iframe").length,
        ...
        function O(a, b, c) {
            var e = a.parts.dialog.getParent().getClientSize(), d = a.getSize(), f = a._.viewportRatio,
                g = Math.max(e.width - d.width, 0), e = Math.max(e.height - d.height, 0);
        ...
        function P(a) {
            var b = a.config, c = CKEDITOR.skinName || a.config.skin,
                e = b.dialog_backgroundCoverColor || ("moono-lisa" == c ? "black" : "white"),
                c = b.dialog_backgroundCoverOpacity, d = b.baseFloatZIndex, b = CKEDITOR.tools.genKey(e, c, d),
                f = D[b];
        ...
        var y = CKEDITOR.tools.cssLength, U, u, F = !CKEDITOR.env.ie || CKEDITOR.env.edge,
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            function d(b) {
                if (n == CKEDITOR.dialog._.currentTop) {
                    ...
                    q = l = 0;
                    if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), q = 1; else if (c == CKEDITOR.ALT + 121 && !n._.tabBarMode && 1 < n.getPageCount()) z(n), q = 1; else if (-1 != CKEDITOR.tools.indexOf(g, c) && n._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ?
            ...
            var g = CKEDITOR.dialog._.dialogDefinitions[b], h = CKEDITOR.tools.clone(U),
                p = a.config.dialog_buttonsOrder || "OS", m = a.lang.dir, k = {}, q, l;
            ...
            this._ = {
                ...
                buttons: {},
                accessKeyMap: {},
                viewportRatio: {width: .5, height: .5},
                tabs: {},
                tabIdList: [],
                currentTabId: null,
            ...
            this.definition = g = CKEDITOR.fire("dialogDefinition",
                {name: b, definition: g, dialog: this}, a).definition;
            ...
            var n = this, t = function (a) {
                var b = n._.contents, c = !1, d;
            ...
            destroy: function () {
                ...
                if (!this._.contentSize || this._.contentSize.width != a || this._.contentSize.height != b) {
                    CKEDITOR.dialog.fire("resize",
                        {dialog: this, width: a, height: b}, this._.editor);
                ...
                var f = this.parts.dialog.getParent().getClientSize(), g = this.getSize(), h = this._.viewportRatio,
                    p = Math.max(f.width - g.width, 0), f = Math.max(f.height - g.height, 0);
                ...
                var a = this._.element, b = this.definition, c = CKEDITOR.document.getBody(),
                ...
                for (var d in b.contents) if (b.contents[d]) {
                    var a = b.contents[d], e = this._.tabs[a.id], c = a.requiredContent, f = 0;
                    if (e) {
                ...
                var a =
                    this.parts.dialog;
                if (this._.moved || !F) {
                    var b = this.getSize(), c = CKEDITOR.document.getWindow().getViewPaneSize(), e;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dialog, {
            CREATION_MODE: 0, EDITING_MODE: 1, add: function (a, b) {
        ...
        var G = function (a, b, c) {
            for (var e = 0, d; d = a[e]; e++) if (d.id == b || c && d[c] && (d = G(d[c], b, c))) return d;
            return null
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function (a, b, c) {
                ...
                if ("function" == typeof d) d = this._.storedDialogs || (this._.storedDialogs = {}), e = d[a] || (d[a] = new CKEDITOR.dialog(this, a)), e.setModel(c), b && b.call(e, e), e.show(); else {
    ...
    CKEDITOR.plugins.add("dialog", {
        requires: "dialogui", init: function (z) {
            ...
            init: function (b) {
                ...
                b.showNotification = function (a, d, e) {
                    ...
                    a = new CKEDITOR.plugins.notification(b,
                        {message: a, type: d, progress: f, duration: l});
                    a.show();
                    return a
                };
                b.on("key", function (c) {
        ...
        r.prototype = {
            add: function (b) {
                ...
                f && f.isVisible() && l.bottom > d.top && l.bottom < d.bottom - u.height ? a.setStyles({
                    ...
                    position: "fixed",
                    top: 0
                }) : a.setStyles({position: "absolute", top: k(e.y + d.height - u.height)});
    ...
    (function () {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function (a, b) {
                ...
                var p = null, q = CKEDITOR.env, r = this._.id = CKEDITOR.tools.getNextId(), g = "", d = this.command, k,
                    l, m;
                this._.editor = a;
                var e = {
                    id: r, button: this, editor: a, focus: function () {
    ...
    (function () {
        ...
        function x(a) {
            ...
            function d() {
                return {
                    ...
                    async: !0, fakeKeystroke: CKEDITOR.CTRL + 86, exec: function (a, b) {
                        ...
                        var d = this, e = "undefined" !== typeof b.notification ? b.notification : !0, g = b.type,
            ...
            function e(b) {
                var c =
                    a.document, d = c.getBody(), e = !1, g = function () {
                    e = !0
                };
                d.on(b, g);
            ...
            function l(b, c) {
                var d = a.document, e = a.editable(), g = function (a) {
                    a.cancel()
                }, m;
                if (!d.getById("cke_pastebin")) {
                    var f = a.getSelection(), l = f.createBookmarks();
            ...
            function t() {
                if ("paste" == p.mainPasteEvent) return a.fire("beforePaste", {type: "auto", method: "paste"}), !1;
                a.focus();
                f();
            ...
            function k(b) {
                var c = {type: "auto", method: "paste", dataTransfer: p.initPasteDataTransfer(b)};
            ...
            var p = CKEDITOR.plugins.clipboard, n = 0, v = 0;
            (function () {
                a.on("key", m);
                a.on("contentDom", b);
            ...
            (function () {
                function b(c, e, d, g, m) {
                    ...
                    a.addCommand(e, d);
                    a.ui.addButton && a.ui.addButton(c, {label: k, command: e, toolbar: "clipboard," + g});
                    a.addMenuItems && a.addMenuItem(e, {label: k, command: e, group: "clipboard", order: m})
                }
            ...
            a.getClipboardData = function (b, c) {
                ...
                function d(a) {
                    a.removeListener();
                    a.cancel();
                    c({type: m, dataValue: a.data.dataValue, dataTransfer: a.data.dataTransfer, method: "paste"})
                }
        ...
        function D(a) {
            ...
            a.on("contentDom", function () {
                ...
                var e = a.editable(), g = CKEDITOR.plugins.clipboard.getDropTarget(a), l = a.ui.space("top"),
                    t = a.ui.space("bottom");
                ...
                e.attachListener(a, "drop", function (e) {
                    if (e = e.data) {
                        var g = e.dropRange, f = e.dragRange, l = e.dataTransfer;
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog,notification,toolbar", init: function (a) {
                function b(a) {
                    ...
                    var b = a.getTypes(), b = 1 === b.length && "Files" === b[0];
                    a = 1 === a.getFilesCount();
                    return b && a
                }
                ...
                if (CKEDITOR.env.gecko) {
                    var f = ["image/png", "image/jpeg", "image/gif"], h;
                    a.on("paste", function (c) {
                        var d = c.data, l = d.dataTransfer;
                ...
                a.on("paste", function (b) {
                    ...
                    if (!b.data.dataValue) {
                        ...
                        if (d) b.data.dataValue = d, b.data.type = "html"; else if (d = c.getData("text/plain")) b.data.dataValue = a.editable().transformPlainTextToHtml(d),
                            b.data.type = "text"
                    }
                }, null, null, 1);
                ...
                a.on("paste", function (b) {
                    b = b.data;
                    var c = a._.nextPasteType || b.type, f = b.dataValue, h,
                    ...
                    if ("text" == c && "html" == h) f = w(a, f, d.get("plain-text")); else if (k && a.pasteFilter && !b.dontFilter || n) f = w(a, f, a.pasteFilter);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            internalDrop: function (a, b, c, d) {
                var f = CKEDITOR.plugins.clipboard, h = d.editable(), e, g;
                d.fire("saveSnapshot");
            ...
            getRangeAtDropPosition: function (a, b) {
                var c = a.data.$, d = c.clientX, f = c.clientY, h = b.getSelection(!0).getRanges()[0],
                    e = b.createRange();
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (g) {
                                ...
                                var q = b.document.$.elementFromPoint(d, f), p = new CKEDITOR.dom.element(q), r;
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function (a, b) {
                ...
                c.substring(0, 7) && (c = "");
                if ("string" === typeof c) var f = c.indexOf("\x3c/html\x3e"), c = -1 !== f ? c.substring(0, f + 7) : c;
                return c
            }, setData: function (a, b) {
                a = this._.normalizeType(a);
                "text/html" == a ? (this._.data[a] = this._stripHtml(b), this._.nativeHtmlCache = b) : this._.data[a] = b;
                if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a || "Text" == a) if ("Text" == n && "Text" == a && (this.id = b), this._.fallbackDataTransfer.isRequired()) this._.fallbackDataTransfer.setData(a, b); else try {
                    this.$.setData(a, b)
                } catch (c) {
                }
            }, storeId: function () {
        ...
        CKEDITOR.plugins.clipboard.fallbackDataTransfer.prototype = {
            isRequired: function () {
                ...
                if (b) return c;
                var c = this._extractDataComment(c), d = null,
    ...
    (function () {
        ...
        var A = CKEDITOR.dom.walker.whitespaces(), B = CKEDITOR.dom.walker.bookmark(), v, u, r, w;
        CKEDITOR.plugins.enterkey =
            {
                enterBlock: function (a, e, b, l) {
                    ...
                    if (b = b || y(a)) {
                        b = z(b);
                        var g = b.document, f = b.checkStartOfBlock(), k = b.checkEndOfBlock(),
                            p = a.elementPath(b.startContainer), c = p.block, m = e == CKEDITOR.ENTER_DIV ? "div" : "p",
                            d;
                        if (c && f && k) {
                            f = c.getParent();
                            ...
                            if (c.is("li") || c.getParent().is("li")) {
                                ...
                                var h = !c.hasNext();
                                l = a.getSelection();
                                var m = l.createBookmarks(), t = c.getDirection(1), k = c.getAttribute("class"),
                                    q = c.getAttribute("style"), r = d.getDirection(1) != t;
                                a = a.enterMode != CKEDITOR.ENTER_BR || r || q || k;
                                if (d.is("li")) b || h ? (b && h && f.remove(), c[h ? "insertAfter" :
                                    "insertBefore"](d)) : c.breakParent(d); else {
                                    if (a) if (p.block.is("li") ? (d = g.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), r && d.setAttribute("dir", t), q && d.setAttribute("style", q), k && d.setAttribute("class", k), c.moveChildren(d)) : d = p.block, b || h) d[b ? "insertBefore" : "insertAfter"](f); else c.breakParent(f), d.insertAfter(f); else if (c.appendBogus(!0), b || h) for (; g = c[b ? "getFirst" : "getLast"]();) g[b ? "insertBefore" : "insertAfter"](f); else for (c.breakParent(f); g = c.getLast();) g.insertAfter(f);
                                    c.remove()
                                }
                                l.selectBookmarks(m);
                                return
                        ...
                        if (q = b.splitBlock(m)) {
                            ...
                            if (f || k) if (n(e)) b.moveToElementEditStart(b.getTouchedStartNode()); else {
                                if (a) {
                                ...
                                if (g = q.elementPath) for (e = 0, l = g.elements.length; e < l; e++) {
                                    m = g.elements[e];
                    ...
                    if (b = b || y(a)) {
                        var n = b.document, g = b.checkEndOfBlock(),
                            f = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), k = f.block,
                            p = k && f.block.getName();
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function (a) {
                ...
                if (a = (a = a.dataProcessor) && a.htmlFilter) {
                    ...
                    var b = k(e.join(",")), d = b.regex ? "[" + b.regex + "]" : "a^";
                    delete b.regex;
            ...
            $: function () {
                ...
                setData: function (a, e) {
                    ...
                    if (e) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady"); else {
                        ...
                        b._.dataStore = {id: 1};
                        var c = b.config, d = c.fullPage, f = c.docType,
                    ...
                    a = this.editor;
                    var e = a.config, b = e.fullPage, c = b && a.docType, d = b && a.xmlDeclaration,
                        f = this.getDocument(), b = b ? f.getDocumentElement().getOuterHtml() : f.getBody().getHtml();
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("indentlist", {
            requires: "indent", init: function (f) {
                ...
                k.registerCommands(f, {indentlist: new g(f, "indentlist", !0), outdentlist: new g(f, "outdentlist")});
                CKEDITOR.tools.extend(g.prototype, k.specificDefinition.prototype, {context: {ol: 1, ul: 1}})
            }
        });
    ...
    (function () {
        ...
        var t = /^javascript:/, u = /^(?:mailto)(?:(?!\?(subject|body)=).)+/i,
            v = /subject=([^;?:@&=$,\/]*)/i, w = /body=([^;?:@&=$,\/]*)/i, x = /^#(.*)$/,
            y = /^((?:http|https|ftp|news):\/\/)?(.*)$/, z = /^(_(?:self|top|parent|blank))$/,
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c, b) {
                var a = c.getSelection(), e = a.getSelectedElement(), f = a.getRanges(), d = [], g;
                if (!b && e && e.is("a")) return e;
                for (e = 0; e < f.length; e++) if (g = a.getRanges()[e], g.shrink(CKEDITOR.SHRINK_ELEMENT, !0, {skipBogus: !0}), (g = c.elementPath(g.getCommonAncestor()).contains("a", 1)) && b) d.push(g); else if (g) return g;
                return b ?
                    d : null
                ...
                return e
            }, fakeAnchor: !0, tryRestoreFakeAnchor: function (c,
                                                               b) {
                ...
                var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    e = c.plugins.link.compiledProtectionFunction, f = c.config.emailProtection, d = {}, g;
                ...
                if (!d.type) if (f = a.match(x)) d.type = "anchor", d.anchor = {}, d.anchor.name = d.anchor.id = f[1]; else if (f = a.match(E)) d.type = "tel", d.tel = f[1]; else if (f = a.match(u)) {
                    g = a.match(v);
                    var a = a.match(w), k = d.email = {};
                    d.type = "email";
                ...
                if (b) {
                    if (a = b.getAttribute("target")) d.target = {
                        ...
                        name: a
                    }; else if (a = (a = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && a.match(C)) for (d.target = {
                        type: "popup",
                        name: a[1]
                ...
                var a = c.config.emailProtection || "", e = {};
                switch (b.type) {
                    case "url":
                    ...
                    case "anchor":
                        ...
                        break;
                    case "email":
                        var d = b.email, f = d.address;
                        switch (a) {
                            case "":
                            case "encode":
                                var g = encodeURIComponent(d.subject || ""), k = encodeURIComponent(d.body || ""),
                                    d = [];
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function (c) {
                var b = c.getSelection(), a = b.createBookmarks(), e;
                if (b && (e = b.getSelectedElement()) && (e.getChildCount() ? e.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, e))) e.remove(1); else if (e = CKEDITOR.plugins.link.getSelectedLink(c)) e.hasAttribute("href") ? (e.removeAttributes({
                    name: 1,
    ...
    (function () {
        ...
        function L(a, l, d) {
            var f = l.contents, e = l.root.getDocument(), g = [];
            ...
            var h, k;
            a = void 0 === a || a;
            for (b = 0; b < f.length; b++) for (var c = f[b], p; p = c.getParent();) {
                if (p.equals(l)) {
                    g.push(c);
        ...
        function N(a, l, d) {
            function f(b) {
                if (!(!(c = k[b ? "getFirst" : "getLast"]()) || c.is && c.isBlockBoundary() || !(p = l.root[b ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) || p.is && p.isBlockBoundary({br: 1}))) a.document.createElement("br")[b ? "insertBefore" : "insertAfter"](c)
            }
            ...
            for (b = h + 1; b < e.length; b++) if (e[b].indent > e[b - 1].indent + 1) {
        ...
        function D(a, l, d) {
            ...
            l.trim(!1, !0);
            var e = l.createBookmark(), g = new CKEDITOR.dom.elementPath(l.startContainer), b = g.block,
                g = g.lastElement.getAscendant("li", 1) || b, h = new CKEDITOR.dom.elementPath(d.startContainer),
        ...
        var u = {ol: 1, ul: 1}, P = CKEDITOR.dom.walker.whitespaces(), I = CKEDITOR.dom.walker.bookmark(),
            t = function (a) {
                return !(P(a) || I(a))
            ...
            listToArray: function (a, l, d, f, e) {
                ...
                for (var g, b = a[d].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(b), k = null, c = d, p = Math.max(a[d].indent, 0), m =
                    ...
                    CKEDITOR.env.needsNbspFiller && 7 >= b.$.documentMode && m.append(b.createText(" ")), m.append(c.listNode), c = c.nextIndex; else if (-1 == q.indent && !d && g) {
                        ...
                        var k = g.getDirection(1) != n, w = q.element, B = w.getAttribute("class"),
                            E = w.getAttribute("style"),
                            J = m.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (f != CKEDITOR.ENTER_BR || k || E || B), v,
                            z = q.contents.length, x;
                        for (g = 0; g < z; g++) if (v = q.contents[g], I(v) &&
                        1 < z) J ? x = v.clone(1, 1) : m.append(v.clone(1, 1)); else if (v.type == CKEDITOR.NODE_ELEMENT && v.isBlockBoundary()) {
        ...
        var M = /^h[1-6]$/, O = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
        C.prototype = {
            exec: function (a) {
                function l(a) {
                ...
                var e = a.config, g = a.getSelection(), b = g && g.getRanges();
                ...
                for (var e = g.createBookmarks(!0), h = [], c = {}, b = b.createIterator(), p = 0; (k = b.getNextRange()) && ++p;) {
                    var m = k.getBoundaryNodes(), n = m.startNode, r = m.endNode;
                    ...
                    for (k.forceBrBreak =
                        ...
                        for (var y = a.elementPath(m), n = y.elements, r = 0, y = y.blockLimit, q, w = n.length - 1; 0 <= w && (q = n[w]); w--) if (u[q.getName()] && y.contains(q)) {
                ...
                var d =
                    l.contains(u, 1), f = l.blockLimit || l.root;
        ...
        CKEDITOR.plugins.add("list", {
            requires: "indentlist", init: function (a) {
                a.blockless || (a.addCommand("numberedlist", new C("numberedlist", "ol")), a.addCommand("bulletedlist", new C("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
                    ...
                    var d = l.data.domEvent.getKey(), f;
                    if ("wysiwyg" == a.mode && d in {8: 1, 46: 1}) {
                        var e = a.getSelection().getRanges()[0], g = e && e.startPath();
                        if (e && e.collapsed) {
                            var b = 8 == d, h = a.editable(), k = new CKEDITOR.dom.walker(e.clone());
    ...
    (function () {
        ...
        var g = [CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89, CKEDITOR.CTRL + CKEDITOR.SHIFT + 90], p = {8: 1, 46: 1};
    ...
    (function () {
        ...
        var q = {
            ...
            position: "absolute",
            top: "-6px"
        }, t = {height: "0px", "border-top": "1px dashed red", position: "absolute", "z-index": 9999};
        p.prototype = {
            removeAll: function () {
        ...
        var r = {left: 1, right: 1, center: 1}, u = {absolute: 1, fixed: 1};
        ...
        CKEDITOR.plugins.widgetselection = {
            ...
            addFillers: function (a) {
                ...
                if (!this.isWholeContentSelected(a) && 0 < a.getChildCount()) {
                    var d = a.getFirst(e), c = a.getLast(e);
            ...
            removeFiller: function (a, b) {
                if (a) {
                    var d = b.editor, c = b.editor.getSelection().getRanges()[0].startPath(), f = d.createRange(), g, e;
    ...
    (function () {
        ...
        function Z(a,
            ...
            a.addCommand(b.name, {
                exec: function (a, d) {
                    ...
                    if (f && f.name == b.name) f.edit(); else if (b.insert) b.insert({
                        editor: a,
                        commandData: d
                    }); else if (b.template) {
                        var f = "function" == typeof b.defaults ? b.defaults() : b.defaults,
                            f = CKEDITOR.dom.element.createFromHtml(b.template.output(f), a.document), h,
        ...
        function aa(a, b) {
            function c(a, c) {
                var e = b.upcast.split(","),
                    d, f;
                for (f = 0; f < e.length; f++) if (d = e[f], d === a.name) return b.upcasts[d].call(this, a, c);
                return !1
            }
            ...
            return {
                toBeWrapped: b, iterator: function (a) {
                    ...
                    if (n = c.length) {
                        ...
                        for (k = 0; k < n; ++k) if (f = c[k], l = {}, h = f[0](a, l)) return h instanceof CKEDITOR.htmlParser.element && (a = h), a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(l)), a.attributes["data-cke-widget-upcasted"] = 1, b.push([a, f[1]]), !1
                    }
                }
            }
        }
        ...
        function T(a) {
            function b() {
                ...
                if ((a = (a && a.getRanges())[0]) && !a.collapsed) {
                    var b = c(a.startContainer), d = c(a.endContainer);
        ...
        function R(a) {
            ...
            b.on("toDataFormat", function (a) {
                if (a.data.downcastingSessionId) for (var b = c[a.data.downcastingSessionId], f, h, l, k, g, m; f = b.shift();) {
                    h = f.widget;
                    l = f.element;
        ...
        function Q(a) {
            ...
            b.on("dataReady", function () {
                if (d) for (var c = b.editable().find(".cke_widget_wrapper"), f, h, l = 0, k = c.count(); l < k; ++l) f = c.getItem(l), h = f.getFirst(g.isDomWidgetElement), h.type == CKEDITOR.NODE_ELEMENT && h.data("widget") ? (h.replace(f), a.wrapElement(h)) : f.remove();
                d = 0;
                a.destroyAll(!0);
                a.initOnAll()
            });
        ...
        function H(a) {
            ...
            return {
                ...
                commit: function () {
                    ...
                    f && e && (l = a.editor.checkDirty(), a.focused = e, a.fire("widgetFocused", {widget: e}), e.setFocused(!0), !l && a.editor.resetDirty());
        ...
        function ia(a) {
            ...
            a.editables = {};
            if (a.editables) for (c in b) d = b[c], a.initEditable(c, "string" == typeof d ? {selector: d} : d)
        }

        function O(a) {
            if (!0 === a.mask) ma(a); else if (a.mask) {
                var b =
                    new CKEDITOR.tools.buffers.throttle(250, na, a), c = CKEDITOR.env.gecko ? 300 : 0, d, e;
                a.on("focus", function () {
                    b.input();
        ...
        function na() {
            if (this.wrapper) {
                ...
                var a = this.parts[this.maskPart], b;
                if (a &&
                    "string" != typeof a) {
                    ...
                    this.mask = b;
                    var c = b.$, d = a.$, e = !(c.offsetTop == d.offsetTop && c.offsetLeft == d.offsetLeft);
        ...
        function oa(a) {
            ...
            if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
                var c = this.repository.finder, d = this.repository.locator, e = this.repository.liner, f = this.editor,
                    h = f.editable(), g = [], k = [], n, m;
                this.repository._.draggedWidget = this;
                var w = c.greedySearch(), r = CKEDITOR.tools.eventsBuffer(50, function () {
                    n = d.locate(w);
                    k = d.sort(m, 1);
        ...
        function pa() {
            ...
            function c(a) {
                ...
                function c(a) {
                    function b(a, c) {
                        var d = CKEDITOR.tools.object.keys(a), e = CKEDITOR.tools.object.keys(c);
                        if (d.length !== e.length) return !1;
                        for (var f in a) if (("object" !==
            ...
            CKEDITOR.style.addCustomHandler({
                type: "widget", setup: function (a) {
                    ...
                    g = a.elementPath();
                    if (this.checkApplicable(g, a)) for (var k = 0, n = this.group.length; k < n; k++) {
        ...
        q.prototype = {
            ...
            checkSelection: function () {
                var a = this.editor.getSelection(), b = a.getSelectedElement(), c = H(this), d;
                ...
                } else for (d in e) c = e[d], this.destroy(c,
                    a)
        ...
        g.prototype =
            {
                addClass: function (a) {
                    ...
                    a || ("0" == this.element.data("cke-widget-keep-attr") && this.element.removeAttribute("data-widget"), this.element.removeAttributes(["data-cke-widget-data",
                        "data-cke-widget-keep-attr"]), this.element.removeClass("cke_widget_element"), this.element.replace(this.wrapper));
                    this.wrapper = null
                }, destroyEditable: function (a, b) {
                    var c = this.editables[a], d = !0;
                ...
                hasClass: function (a) {
                    ...
                    return c && c.is(CKEDITOR.dtd.$editable) ? (c = new t(this.editor, c, {filter: B.call(this.repository, this.name, a, b)}), this.editables[a] = c, c.setAttributes({
                    ...
                    for (var b, c, d = 0; d < a.count(); d++) if (b = a.getItem(d), c = b.getAscendant(g.isDomWidgetWrapper), this.wrapper.equals(c)) return b;
                    return null
                }, isInited: function () {
        ...
        var fa = /^(?:<(?:div|span)(?: data-cke-temp="1")?(?: id="cke_copybin")?(?: data-cke-temp="1")?>)?(?:<(?:div|span)(?: style="[^"]+")?>)?<span [^>]*data-cke-copybin-start="1"[^>]*>.?<\/span>([\s\S]+)<span [^>]*data-cke-copybin-end="1"[^>]*>.?<\/span>(?:<\/(?:div|span)>)?(?:<\/(?:div|span)>)?$/i,
            P = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1};
        ...
        var u = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                createCopyBin: function (a) {
                    var b = a.document, c = CKEDITOR.env.edge && 16 <= CKEDITOR.env.version,
                        d = !a.blockless && !CKEDITOR.env.ie || c ? "div" : "span", c = b.createElement(d),
                        b = b.createElement(d);
                    b.setAttributes({id: "cke_copybin", "data-cke-temp": "1"});
                    c.setStyles({position: "absolute", width: "1px", height: "1px", overflow: "hidden"});
                ...
                handle: function (a) {
                    var b = this.copyBin, c = this.editor, d = this.container,
                        e = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, f = c.document.getDocumentElement().$,
                        h = c.createRange(), g = this, k = CKEDITOR.env.mac && CKEDITOR.env.webkit, n = k ? 100 : 0,
    ...
    (function () {
        ...
        var r = !1, v = {
            caption: function () {
                ...
                var c = {
                    progressReporterType: n, setUp: function (a, b) {
                ...
                return {
                    allowedContent: {a: {attributes: "!href"}}, parts: {link: "a"}, init: function () {
        ...
        CKEDITOR.plugins.add("imagebase", {
            requires: "widget,filetools", lang: "en", init: function (c) {
        ...
        CKEDITOR.plugins.imagebase = {
            featuresDefinitions: v, addImageWidget: function (c, a, b) {
                ...
                c.features.push(a);
                return c
            }, progressBar: n, progressReporter: m
        }
    })();
    (function () {
        var f = !1;
        ...
        CKEDITOR.ui.balloonPanel.prototype = {
            ...
            build: function () {
                ...
                function f(a, b) {
                    var c = b ? a[0] : a[a.length - 1], e = b ? "top" : "bottom";
                ...
                return function (p, l) {
                    if (p instanceof CKEDITOR.dom.selection) {
                        var d = p.getRanges(),
                            ...
                            }) : d[d.length - 1].getClientRects(!0), e = d[0], f = d[d.length - 1], r;
                    ...
                    var d = this.getWidth(), e = this.getHeight(), f = d * e, g, k, h;
                    g = p.getClientRect && p.getClientRect(!0);
                    var t = q ? x.getClientRect(!0) : v.getClientRect(!0), y = u.getViewPaneSize(),
                        w = u.getScrollPosition(), m = {
                ...
                var c = this.parts.triangleOuter, f = this.parts.triangleInner;
    ...
    (function () {
        ...
        h.prototype = {
            create: function (a) {
                ...
                if (a) {
                    var f = CKEDITOR.tools.array.forEach, d = a.getRanges()[0], e = d && d.startPath(), g, k;
                    ...
                    if (e) for ((d = a.getSelectedElement()) && !d.isReadOnly() && b(this._contexts, c, d), d = 0; d < e.elements.length; d++) {
                        var h = e.elements[d];
        ...
        CKEDITOR.plugins.add("balloontoolbar", {
            requires: "balloonpanel", isSupportedEnvironment: function () {
                ...
                m || (m = !0, CKEDITOR.ui.balloonToolbarView.prototype = CKEDITOR.tools.extend({}, CKEDITOR.ui.balloonPanel.prototype), CKEDITOR.ui.balloonToolbarView.prototype.build = function () {
                    ...
                    if (!this.rect.visible) {
                        var c = this.editor, f = c.editable(),
                            d = f.isInline() ? f : f.getDocument(), e = CKEDITOR.document.getWindow();
                    ...
                    return {"bottom hcenter": a["bottom hcenter"], "top hcenter": a["top hcenter"]}
                    ...
                    var c = [], f = CKEDITOR.tools.object.keys(a), d = !1;
                    this._deregisterItemFocusables();
        ...
        CKEDITOR.plugins.balloontoolbar = {context: g, contextManager: h, PRIORITY: {LOW: 999, MEDIUM: 500, HIGH: 10}}
    })();
    (function () {
    ...
    (function () {
        CKEDITOR.plugins.add("cloudservices", {
            requires: "filetools,ajax", onLoad: function () {
                function a(a, b, f, d) {
                    c.call(this, a, b, f);
                    this.customToken = d
                }
    ...
    (function () {
        ...
        function p(a, c) {
            function b(a) {
                return function (b, d) {
                    var c = b.widgets.focused, e = CKEDITOR.TRISTATE_DISABLED;
        ...
        function t(a, c) {
            var b = a.config, e = b.easyimage_class, b = {
                name: "easyimage",
                allowedContent: {
                ...
                _loadDefaultStyle: function () {
                    var b = !1, e = a.config.easyimage_defaultStyle, d;
                    for (d in c) {
        ...
        function u(a) {
            ...
            a.on("paste", function (b) {
                if (!a.isReadOnly && c.test(b.data.dataValue)) {
                    b = b.data;
                    var e = document.implementation.createHTMLDocument(""), e = new CKEDITOR.dom.element(e.body),
                        f = a.widgets.registered.easyimage, l = 0, d, g, k, m;
                    ...
                    for (m = 0; m < g.count(); m++) {
                        ...
                        h && n && !k.isReadOnly(1) && (l++, 1 < l && (h = a.getSelection().getRanges(), h[0].enlarge(CKEDITOR.ENLARGE_ELEMENT), h[0].collapse(!1)), d.match(/image\/([a-z]+?);/i), h = f._spawnLoader(a,
                            d, f), d = f._insertWidget(a, f, d, !1, {uploadId: h.id}), d.data("cke-upload-id", h.id), d.replace(k))
                    }
                ...
                exec: function () {
                    ...
                    c.once("change", function (b) {
                        ...
                        b.$.files.length && a.fire("paste", {
                            method: "paste",
                            dataValue: "", dataTransfer: new CKEDITOR.plugins.clipboard.dataTransfer({files: b.$.files})
                        })
                    });
                    c.$.click()
                }
        ...
        CKEDITOR.plugins.add("easyimage", {
            requires: "imagebase,balloontoolbar,button,dialog,cloudservices", lang: "en", onLoad: function () {
                ...
                if (this.isSupportedEnvironment()) {
                    ...
                    for (var b in c) a.ui.addButton("EasyImage" + f(b), {
                        label: c[b].label, command: "easyimage" + f(b), toolbar: "easyimage,99", icon: c[b].icon,
